...
class Twitter(APIView):
    def post(self, request):
        ...
        if(len(negative)>0) :
            ...
            new_model=load_model(r"C:\Devops Repo\New folder\Detecting-Depression-in-Social-Media-via-Twitter-Usage-20220819T110855Z-001\Detecting-Depression-in-Social-Media-via-Twitter-Usage\twitter_model.h5")
            labels_pred=new_model.predict(res)
